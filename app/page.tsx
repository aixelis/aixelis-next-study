...
const translations = {
  'zh-TW': {
    ...
    aboutDesc: '我們是在洛杉磯深耕多年的專業維修團隊。保證您的每一次維修都安全、合規、無後顧之憂。無論是深夜的空調故障，還是突發的漏水斷電，我們承諾為您提供最迅速、最透明的報價與服務。',
    hvacTitle: '暖通空調 (HVAC)',
  ...
  'en': {
    ...
    aboutDesc: 'We are a highly experienced home services team rooted in Los Angeles. We guarantee that every repair is safe, compliant, and worry-free. Whether it’s a late-night AC breakdown or a sudden plumbing emergency, we promise fast response times and transparent pricing.',
    ...
    <main className="min-h-screen bg-gray-50 font-sans relative pb-10">
      ...
      <section className="max-w-7xl mx-auto py-10 px-6 grid md:grid-cols-3 gap-8">
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden hover:shadow-2xl transition transform hover:-translate-y-2 flex flex-col">
          {/* 这里换了一张非常明显的空调机组图片 */}
          <div className="h-48 bg-cover bg-center" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1527628173875-3c7bfd28ad78?auto=format&fit=crop&q=80&w=800')" }}></div>
